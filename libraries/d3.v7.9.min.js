  ...
  pe(ye, ze, {
    ...
    pe(
      ...
      ge(ye, {
        ...
        formatHsl() {
          const t = Oe(this.opacity);
          return `${1 === t ? "hsl(" : "hsla("}${Ge(this.h)}, ${100 * Ve(this.s)}%, ${100 * Ve(this.l)}%${
            1 === t ? ")" : `, ${t})`
          }`;
        },
      })
      ...
      null === this._x1
        ...
        e &&
          ...
          l > Fa
            ...
            : l > Ra &&
              this._append`A${e},${e},0,${+(l >= $a)},${s},${(this._x1 = t + e * Math.cos(i))},${(this._y1 =
                n + e * Math.sin(i))}`);
    }
    rect(t, n, e, r) {
  ...
  function I_(t, n, e, r, i, o, a, u, c, f) {
    ...
    return (
      ...
      (s.nice = function (t) {
        var e = h();
        return (
          (t && "function" == typeof t.range) || (t = n(e[0], e[e.length - 1], null == t ? 10 : t)), t ? h(kg(e, t)) : s
        );
      }),
      (s.copy = function () {
